    <footer class="" style="padding: 0 110px; margin-top: 150px;">
        <div class=" p-4">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
                    ...
                    <a class="text-decoration-none fs-6 fw-bolder" href="#"><span class="text-start"><img
                                class="img-fluid " src="{{ asset('img/lgo.png') }}" width="50px" height="50px"
                ...
                <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled text-decoration-none mb-0">
                        <li>
                            <a href="#!" class=" text-decoration-none fs-6  " style="color: #777777;">API
                                Reference insurance</a>
                        </li>
                        <li>
                            <a href="#!" class=" text-decoration-none fs-6" style="color: #777777;">Help
                                Center</a>
                        </li>
                        <li>
                            <a href="#!" class=" text-decoration-none fs-6" style="color: #777777;">Live
                                Chat</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
                    ...
                    <div class="d-flex justify-content-center">
                        <a class="text-decoration-none fw-bolder" href="#"><img class="img-fluid "
                                src="{{ asset('img/lgo.png') }}" width="120px" height="120px" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="text-start p-3 d-grid" style=" grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 10px;">
            <div>
                ...
                <h6 class="text-start fw-lighter fs-6 me-3" style="color: #777777;letter-spacing: 0px;">© 2024 MY
            ...
            <div class="">
                ...
                <h5 class="text-center fw-lighter fs-6 mt-2" style="color: #777777;letter-spacing: 0px;">
                    support@myfutsal
