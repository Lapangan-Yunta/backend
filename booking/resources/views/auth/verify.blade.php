...
@section('content')
    <div class="about-container" style="display: grid; grid-template-columns: 1fr 1fr; gap: 5px; margin-top: 50px;">
        ...
        <div class="hero-right " style="margin-top: 80px;">
            ...
            <p class="fw-bold mt-2" style="text-align: justify;padding-right: 400px; color: #686D76;">Silakan cek email Anda
                untuk kode verifikasi yang telah kami kirim. Terima kasih!</p>
            <p class="fw-bold" style="color: #b31312; margin-top: -15px;">MY FUTSAL</p>
            <p class="fw-light mt-3" style="font-size: 14px;">Email Anda Sudah Terdaftar? <a href="/auth/register"
                    style="color: #b31312;">Klik Disini Untuk Melakukan Registrasi Kembali</a></p>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label fw-light"
                    style="font-size: 14px;margin-bottom: -20px;">Kode Verifikasi Email :</label>
                <input type="text" class="form-control" style="width: 550px; height: 50px;" id="exampleFormControlInput1"
                    placeholder="123456">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label fw-light"
                    style="font-size: 14px;margin-bottom: -20px;">Lengkapi Akun :</label>
                <input type="email" class="form-control mb-2" style="width: 550px; height: 50px;"
                    id="exampleFormControlInput1" placeholder="Username@gmail.com">
                <input type="text" class="form-control mb-2" style="width: 550px; height: 50px;"
            ...
            <p class="fw-light mt-3" style="font-size: 14px;">Tidak Menerima Kode Verifikasi? <a href=""
                    style="color: #b31312;">Klik Disini Untuk Bantuan</a></p>
        </div>
